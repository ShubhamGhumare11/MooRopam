...
const SubCard6 = () => {
    ...
    const handleCheckout = () => {
        const serviceData = {
            productName: "Business name suggestion",
            price: "₹ 2800",
        };
            ...
            <div className="flex flex-col md:flex-row items-start mt-4 md:mt-8 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 space-y-6 md:space-y-0 overflow-x-hidden">
                ...
                <div className="flex-1 p-2 sm:p-6 md:p-8 lg:p-10 font-serif">
                    ...
                    <p className="text-xs sm:text-sm md:text-base lg:text-lg tracking-wide mb-4">
                        Most of the successful companies and brand names add up to auspicious numbers and that is also a reason of success along with their hard work.

                        You can also keep your business name as per Numerology for better results.

                        If you want to start your own business, we will provide auspicious starting alphabets and will give you auspicious names for the business (from the given choices of names).
                    </p>
