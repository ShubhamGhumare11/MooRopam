...
const USDservices3 = () => {
  ...
  const handleCheckout = () => {
    const serviceData = {
      productName: "Mobile Number Selection",
      price: "$ 10",  
    };
      ...
      <div className="flex flex-col md:flex-row items-start mt-4 md:mt-8 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 space-y-6 md:space-y-0 overflow-x-hidden">
        ...
        <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold mb-2 text-yellow-600">
                    ...
                    <p className="text-xs sm:text-sm md:text-base lg:text-lg tracking-wide mb-4">
                        Nowadays Mobile is like an organ of our body and we are connected to the whole world through mobile number. Don’t you think it’s frequency should also be auspicious for you.

                        We will guide you as per your date of birth, how it should be?

                        Which will be helpful to inculcate positive vibrations.
                    </p>
