...
const USDservices9 = () => {
  ...
  const handleCheckout = () => {
    const serviceData = {
        productName: "Full Numerology Telephonic Consultation",
        price: "$ 150",
    };
