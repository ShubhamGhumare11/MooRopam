...
const USDservices5 = () => {
  ...
  const handleCheckout = () => {
    const serviceData = {
      productName: "Name spelling change or Baby name suggestion",
      price: "$ 50",  
    };
      ...
      <div className="flex flex-col md:flex-row items-start mt-4 md:mt-8 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 space-y-6 md:space-y-0 overflow-x-hidden">
        ...
        <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold mb-2 text-yellow-600">
                    ...
                    <p className="text-xs sm:text-sm md:text-base lg:text-lg tracking-wide mb-4">
                        Most of the successful celebrities have changed their names as per Numerology.

                        They have added or removed few alphabets to their names for making it auspicious and that is also a reason of their success along with their hard work.

                        You can also keep your name or your baby name as per Numerology for better results.
                    </p>
