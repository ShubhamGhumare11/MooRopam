...
const USDservices1 = () => {
  ...
  const handleCheckout = () => {
    const serviceData = {
      productName: "Vehicle Number Selection",
      price: "$ 10",
    };
      ...
      <div className="flex flex-col md:flex-row items-start mt-4 md:mt-8 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 space-y-6 md:space-y-0 overflow-x-hidden">
        ...
        <div className="flex-1 p-2 sm:p-6 md:p-8 lg:p-10 font-serif">
          ...
          <p className="text-xs sm:text-sm md:text-base lg:text-lg tracking-wide mb-4">
            Most of the celebrities, actors, politicians, and followers of numerology use their car or bike with a special VIP number actually suggested as per numerology, which has proved auspicious or lucky for them. If your vehicle is lucky for you, the same vehicle can prove lucky for you and may give you less trouble.
          </p>
